...
class NewVisitorTest(StaticLiveServerTestCase):
    ...
    def test_can_start_a_list_and_retrieve_it_later(self):
        ...
        # She notices the browser and header mention to do lists
        ...
        # now the page lists "1: Buy Peacock feathers" as an item in the to-do list table
        ...
        ## We use a new browser session to make sure no information of Edith's is coming through from cookies, etc.
        self.browser.quit()
        self.browser = webdriver.Firefox()
